...
#define TIME_ONE_SECOND		(1000000/TIME_BASE)
 ...
 //   UCHAR                   Wsc_Uuid_Str[UUID_LEN_STR];
	...
	struct IKANOS_TX_INFO	IkanosRxInfo[HW_BEACON_MAX_NUM + MAX_WDS_ENTRY + MAX_APCLI_NUM + MAX_MESH_NUM];
#endif // IKANOS_VX_1X0 //
...
VOID RT3593_AsicVCOCalibration(
	IN PRTMP_ADAPTER pAd);
#endif // RT3593 //
...
dma_addr_t RtmpDrvPciMapSingle(
	IN	PRTMP_ADAPTER			pAd,
	IN	VOID					*ptr,
	IN	size_t					size,
	IN	int						sd_idx,
