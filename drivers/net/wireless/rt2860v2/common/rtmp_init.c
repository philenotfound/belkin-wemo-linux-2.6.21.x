...
//		pAd->bTest1 = TRUE;
	...
	DBGPRINT(RT_DEBUG_OFF, ("%s: pAd->TxPowerCtrl.bInternalTxALC = %d\n", 
		__FUNCTION__, 
		pAd->TxPowerCtrl.bInternalTxALC));
#endif // RTMP_INTERNAL_TX_ALC //
...
#if defined(RT3593) || defined(RT5350)
	if (IS_RT3593(pAd) || IS_RT5350(pAd))
	{
		/*
			Only for RT3593.
...
#ifdef WSC_V2_SUPPORT
			pWscControl->WscConfigMethods= 0x028C;
#else
...
#ifdef WSC_V2_SUPPORT
				pWscControl->WscConfigMethods= 0x0284;
#else
...
#if defined(RT3593) || defined(RT5350)
	if (IS_RT3593(pAd) || IS_RT5350(pAd))
		pAd->FreqCalibrationCtrl.bEnableFrequencyCalibration = FALSE; // Off by default
#endif // RT3593 //
